...
export function StatsCard({ title, value, subtitle, trend, variant = 'default', progress }: StatsCardProps) {
  return (
    <div className={`bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-xl ${variant === 'accent' ? 'border-l-4 border-l-blue-600 shadow-sm' : ''}`}>
